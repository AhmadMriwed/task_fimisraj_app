...
class ColorManager{
  static const primary = Color(0xff007AFF);// اللون الاساسي
  static const secondary = Color(0xff12B0F8);
  ///
  ...
  ///--- gradient
  static const Color startColor = Color(0xFF007AFF);
  static const Color endColor = Color(0xFF12B0F8);
